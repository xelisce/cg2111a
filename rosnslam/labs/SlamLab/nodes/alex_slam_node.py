...
SCANNING_FREQUENCY = 5 #initial 5
SCANNING_FIELD_OF_VIEW = 360
DISTANCE_IF_NO_OBSTACLE = 12000 #TODO make it 3m initial is 120000
HOLE_WIDTH_MM = 100
...
# Map Constants
MAP_QUALITY = 5
MAP_SIZE_PIXELS = 500 #initial 500
MAP_SIZE_METERS = 8 #initial 8
MAP_SIZE_MILLIMETERS = MAP_SIZE_METERS * 1000
LIDAR_OFFSET_DEGREES = 0 # in case your lidar 'Front' (i.e. 0 degrees) is not aligned with the robot initial -90

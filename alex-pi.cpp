...
void getParams(TPacket *commandPacket)
{
  ...
  // Print usage
  printf("NCURSES CONTROLS:\n");
  printf(" w=forward, a=left, d=right, r=reverse\n");
  printf(" s=stop, c=clear stats, g=get stats,\n");
  printf(" u=servo up, j=servo down, q=quit\n");
  printf(" Y = Open Front Claw, U = Close Front Claw \n");
  printf(" I = Deposit, O = Undeposit\n");
